"""FantasyPros (FP) variant of test_draft_simulation.py -- same simulated
15-round, 12-team snake draft, but driving draft_math_fp.py against
data/projections_fp.csv instead of the default engine/CSV pair.
"""
...
MY_SLOT = 1
CSV_PATH = "data/projections_fp.csv"
...
print("=== My draft picks (FP engine) ===")
...
print("\nSIMULATION PASSED (FP engine): balanced Hero RB / PPR structure, zero positional over-saturation.")
