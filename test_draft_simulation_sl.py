"""Sleeper (SL) variant of test_draft_simulation.py -- same simulated
15-round, 12-team snake draft, but driving draft_math_sl.py against
data/projections_sl.csv instead of the default engine/CSV pair.
"""
...
MY_SLOT = 1
CSV_PATH = "data/projections_sl.csv"
...
print("=== My draft picks (Sleeper engine) ===")
...
print("\nSIMULATION PASSED (Sleeper engine): balanced Hero RB / PPR structure, zero positional over-saturation.")
