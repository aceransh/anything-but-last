...
def load_projections(csv_path: str = "data/projections_fp.csv") -> pd.DataFrame:
...
def _league_baseline_lineup(csv_path: str = "data/projections_fp.csv") -> tuple:
...
def generate_pareto_candidate_stream(
    ...
    csv_path: str = "data/projections_fp.csv",
    roster=None,
    round_num: int = 1,
    total_rounds: int = 15,
