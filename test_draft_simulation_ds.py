"""DraftSharks (DS) variant of test_draft_simulation.py -- same simulated
15-round, 12-team snake draft, but driving draft_math_ds.py against
data/projections_ds.csv instead of the default engine/CSV pair.
"""
...
MY_SLOT = 1
CSV_PATH = "data/projections_ds.csv"
...
print("=== My draft picks (DS engine) ===")
...
print("\nSIMULATION PASSED (DS engine): balanced Hero RB / PPR structure, zero positional over-saturation.")
